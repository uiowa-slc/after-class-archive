...
<!-- main content goes here -->
					<table cellpadding="0" cellspacing="0" width="600"  style="text-align: left;">
						...
						<tr><td width="600" colspan="2" height="215" valign="top">
							<a href="http://afterclass.uiowa.edu"><img src="http://afterclass.uiowa.edu/assets/newsletter/newsletter_header.png" alt="After Class" border="0"/></a>
						</td></tr>
...
<% control FeaturedEvent %>
						<tr width="598"  style="border-style: solid;">
							<td width="600" colspan="2" style="padding: 0px; margin:0px;">
								...
								<h1 style="padding: 5px 5px 5px 15px; margin:0px; color:#2791a7; font-weight: bold; font-size:34px; ">$Title</h1>
								<center>
								<a href="$AbsoluteLink">
								<% control Image %>
								...
								<div style="font-size:20px;padding:0; margin:0; color: #000 !important;">$Content.LimitWordCount(30)</div>
									...
									<td width="110px">
									<h5  style="width:180px; height:33px; background-color:#2791AE; border-radius:10px; text-align:center; valign:center; font-size: 25px; color:#FFF !important; margin:0;"> view event</h5></a>
									</td>
									</tr>
									</table>
<% end_control %>
...
<table style="margin: 10px 0px 10px 0px; text-align: left;" width="600">
				...
				<h1 style="margin: 0px 0px 5px 0px;"><a href="$BlogLink" style="color: #2791a7; padding-bottom: 3px; text-decoration: none;">$BlogTitle</a></h1>
				<tr>
			<% if Image %>
...
<!-- DSL -->
<table style="margin: 10px 0px 10px 0px;" width="600" bgcolor="#1d1d1f">
	<tr>
