...
<div id="homepage-event-list">
	...
	<div class="homepage-event $EvenOdd $FirstLast <% if Event.CancelReason %>canceled<% end_if %>">
		...
		<div class="homepage-event-content">
			...
			<% end_control %>
	<a href="$Event.Link" class="more-event-info">view event</a>
	<!--<a href="#" class="more-event-info">get directions</a>-->
				...
				<div class="when">
					...
					<% control Event.DateAndTime %>
						<li> <a href="{$BaseHref}events/view/$StartDate.Format(Ymd)" class="date-link">$StartDate.format(M). $StartDate.format(j) </a>
							<% if EndDate %>
							- <a href="{$BaseHref}events/view/$EndDate.Format(Ymd)" class="date-link"> $EndDate.format(M). $EndDate.format(j) </a>
							<% end_if %>
							<% if StartTime %>
							<li>$StartTime.Nice</li>
							<% end_if %>
						</li>
						<% end_control %>
...
<iframe src="//www.facebook.com/plugins/likebox.php?href=https%3A%2F%2Fwww.facebook.com%2Fpages%2FAfter-Class%2F319621914746674&amp;width=350&amp;height=258&amp;colorscheme=dark&amp;show_faces=true&amp;border_color=%23444&amp;stream=false&amp;header=false&amp;appId=242901859120617" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:350px; height:258px;" allowTransparency="true" class="facebook-iframe"></iframe>
	</div><!-- end newsletter-signup -->
	
	<div id="approaching-deadlines">
		<h2><img src="{$ThemeDir}/images/approaching_deadlines.png" alt="Approaching Deadlines" /></h2>
	...
	<div id="the-dome">
		<h2><a href="#"><img src="{$ThemeDir}/images/underthedome_test.png" alt="Under the Dome Student Blog" /></a></h2>
