<p class="dates-times">
	...
	<% if $NextDateTime %>
		<a href="$DateLink" class="date-link" ><time itemprop="startDate" datetime="$StartDate.format(c)" class="$FirstLast">$NextDateTime.ShortMonth() $NextDateTime.DayOfMonth()</time></a>
	<% end_if %>	
