	...
	<div class="row d-flex <% if $Image.Orientation != "Wide" %>pt-4 pt-xl-5<% end_if %> justify-content-center">
		<div class="col-lg-7 col-xl-8">
			<article>
                ...
                <% if $Dates.Count > 10 %>
                <p><button class="btn btn-outline-white br-0 btn-secondary" type="button" data-toggle="collapse" data-target="#moreDates" aria-expanded="false" aria-controls="moreDates">
                    More Dates <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
