<div class="social-card mb-3" itemscope="" itemtype="http://data-vocabulary.org/Event" style="position: relative;">
	<div class="social-card-body">
		<a href="$SocialLink"><img class="d-block lazyload w-100" src="$SocialImageUrl" 
...
<%-- 		<div class="social-card-subtitle">
		...
		<a href="$SocialAuthorUrl" class="social-card-sig"><i class="fab fa-instagram"></i> $SocialAuthorName</a>
