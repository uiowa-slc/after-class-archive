...
<% if Content %>
	...
	<link rel="stylesheet" href="{$ThemeDir}/css/bootstrap-responsive.css">
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="#">After Class: The Best of UI's Culture, Events and Nightlife</a>
...
<script src="{$ThemeDir}/js/libs/bootstrap/bootstrap.min.js"></script>
