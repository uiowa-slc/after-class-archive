...
class ConnectPage extends Page {
	...
	function getCMSFields() {
		...
		$fields->addFieldToTab('Root.Content.Main', new TextField( 'FB1', 'Facebook' ) );
		$fields->addFieldToTab('Root.Content.Main', new TextField( 'FB2', 'Facebook' ) );
		$fields->addFieldToTab('Root.Content.Main', new TextField( 'FB3', 'Facebook' ) );
		$fields->addFieldToTab('Root.Content.Main', new TextField( 'FB4', 'Facebook' ) );
		$fields->addFieldToTab('Root.Content.Main', new TextField( 'FB5', 'Facebook' ) );
		$fields->addFieldToTab('Root.Content.Main', new TextField( 'FB6', 'Facebook' ) );
		$fields->addFieldToTab('Root.Content.Main', new TextField( 'FB7', 'Facebook' ) );
		$fields->addFieldToTab('Root.Content.Main', new TextField( 'FB8', 'Facebook' ) );
		$fields->addFieldToTab('Root.Content.Main', new TextField( 'FB9', 'Facebook' ) );
